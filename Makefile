...
extract_v1:
	...
	Rscript "R/extractPDKitRotationFeatures_V1_Tables.R" -s "syn10308918" -o "mpowerV1_walking_return_PDKitRotationFeatures.tsv" -p "syn24182621" -e "~/env" -f "deviceMotion_walking_rest.json.items"
